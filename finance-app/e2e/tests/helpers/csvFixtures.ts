...
export const HEADER_ONLY_CSV = 'bankName,accountNumber,accountType,balance,currency,asOfDate\n';
...
/**
 * Lenient parsing: extra trailing column `notes` appended after the required six.
...
export const EXTRA_COLUMN_CSV = [
  ...
  'Chase,000111222,CHECKING,1500.00,USD,2026-08-31,some note',
  'Wells Fargo,333444555,SAVINGS,8200.50,USD,2026-08-31,another note',
].join('\n');
...
export const WRONG_ORDER_CSV = [
  ...
  '000111222,Chase,CHECKING,1500.00,USD,2026-08-31',
].join('\n');

/** Schema error: `accountNumber` is misspelled as `acctNumber`. */
export const TYPO_COLUMN_CSV = [
  'bankName,acctNumber,accountType,balance,currency,asOfDate',
  'Chase,000111222,CHECKING,1500.00,USD,2026-08-31',
].join('\n');
...
export const MULTI_ROW_ERRORS_CSV = [
  ...
  'Chase,000111222,MORTGAGE,1500.00,USD,2026-08-31',
  ',333444555,SAVINGS,8200.50,USD,2026-08-31',
  'Citi,666777888,CHECKING,not-a-number,USD,2026-08-31',
].join('\n');
...
export const MIXED_VALID_INVALID_CSV = [
  'bankName,accountNumber,accountType,balance,currency,asOfDate',
  'Chase,000111222,CHECKING,1500.00,USD,2026-08-31',
  'Wells Fargo,333444555,MORTGAGE,8200.50,USD,2026-08-31',
].join('\n');
